	...
	<div class="container">
		<div class="row">
			...
			<div class="container col-9">
				...
				<!-- 목록으로 -->
				<a id="btnbar" class="btn col-12" href="<%= request.getContextPath() %>/serviceCenter/noticeBoard/noticeBoardList"><span class="material-icons">chevron_left</span>&nbsp목록으로</a>
