		    ...
		    <div class="row">
		      <div class="col-4">
					<div class="form-outline mb-4">
				      ...
				      <input type="text" id="form6Example4" class="form-control" name="phone" value="<%= board.getPhone()%>"/>
			    	</div>
					...
					<div class="row">
					    ...
					    <div class="form-outline mb-4 col-6">
					      ...
					      <input type="number" id="weight" class="form-control" name="weight" value="<%=board.getWeight() %>"/>
					    </div>
					</div>
			    ...
			    <div class="form-outline mb-4">
			      ...
			      <input type="text" id="form6Example6" class="form-control" name="color" value="<%= board.getColor()%>"/>
			    </div>
			  
			  	<!--특징 -->
			    <div class="form-outline mb-4">
			      <label class="form-label" for="form6Example6">특징</label>
			      <input type="text" id="form6Example6" class="form-control" name="character" value="<%=board.getCharacter()%>"/>
			    </div>  
			  	...
			  	<div class="row">
					<div class="form-outline mb-4 col-6">
						...
						<div>
							<input type="date" class="form-control" name="missDate" id="missDate" value="<%= board.getMissDate()%>">
						</div>
					</div>
					
					<div class="form-outline mb-4 col-6">
						<label for="status" class="col-form-label">상태</label>
						<select class="form-select" name="status" id="status" aria-label="Default select example" value="<%=board.getStatus()%>">
...
<!-- 			<label for="day" class="col-sm-1 col-form-label">완료여부</label>
	   ...
	   <!-- 내용 input -->
	    <div class="form-outline mb-4">
	      <textarea class="form-control" rows="4" placeholder="내용을 입력해주세요" name="content"><%= board.getContent()%></textarea>
	    </div>				
