	...
	<div class="container">
		...
		<form
			...
			<div class="row">
				<div class="col-md-4">
					<!-- 봉사 게시글 썸네일 이미지 -->
					<img src="<%= request.getContextPath() %>/images/blank-profile-640.png" class="img-thumbnail" alt="사진">
				...
				<div class="col-md-8">
					...
					<div class="mb-2 row">
						...
						<div class="col-sm-10">
							<input type="text" placeholder="이름 입력" class="form-control" name="title" id="title">
						</div>
					</div>
					...
					<!-- 센터명 -->
					<div class="mb-2 row">
						<label for="centerName" class="col-sm-2 col-form-label">품종</label>
						<div class="col-sm-10">
							<input type="text" placeholder="품종 입력" class="form-control" name="centerName" id="centerName">
						</div>
					</div>
					
					<!-- 봉사시작일 / 종료일. 유효성 검사에 봉사 시작일보다 종료일이 앞서지 않게 만들것 -->
					<div class="mb-2 row">
						<label for="startDate" class="col-sm-2 col-form-label">태어난 날</label>
						<div class="col-sm-4">
