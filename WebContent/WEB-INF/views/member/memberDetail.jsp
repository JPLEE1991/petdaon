...
function fnUpdate() {
	...
	$('form[name=enrollFrm]')[0].action	= '<%=request.getContextPath()%>/member/memberDetail';
 ...
 */
function fnLeave() {
	$('form[name=enrollFrm]')[0].action	= '<%=request.getContextPath()%>/member/memberLeave';
	$('form[name=enrollFrm]')[0].submit();
}
		...
		<div class="col-sm-6 col-sm-offset-3">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<form name="enrollFrm" action="<%=request.getContextPath()%>/member/memberDetail"  method="post">
