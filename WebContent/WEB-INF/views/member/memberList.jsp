...
<%@ include file="/WEB-INF/views/common/header.jsp" %>
	...
	<div class="join-title"><h1>회원목록(<%=list.size() %>)</h1></div>
	<div class="row">
				...
				<div class="panel-body">
					<table>
						<tbody>
							...
							<tr>
								<td>
									<a href="<%=request.getContextPath()%>/member/memberDetail?memberId=<%=member.getMemberId() %>"><%=member.getMemberId() %></a>
								</td>
								<td>
									<a href="<%=request.getContextPath()%>/member/memberDetail?memberId=<%=member.getMemberId() %>"><%=member.getMemberName() %></a>
								</td>
