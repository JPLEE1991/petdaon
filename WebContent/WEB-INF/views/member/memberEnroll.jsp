		...
		<div class="col-sm-6 col-sm-offset-3">
			<div class="panel panel-default">
				<div class="panel-body">
					<form name="enrollFrm" action="<%=request.getContextPath()%>/member/memberEnroll"  method="post">
						...
						<div class="form-group">
							...
							<input type="password" id="passwordck" name="passwordck" class="form-control" placeholder="비밀번호확인을 입력해주세요">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" id="birthday" name="birthday" class="form-control" placeholder="생년월일을 입력해주세요">
						</div>
						<div class="form-group">
							<label for="phone">전화번호</label>
							<input type="text" id="phone" name="phone" class="form-control" placeholder="전화번호를 입력해주세요">
						</div>
						<button type="submit" id="joinBtn" class="btn btn-info btn-lg btn-block" onclick="javascript:fnDoSubmit(); return false;">회원가입</button>
					</form>
				</div>
			</div>
		</div>
