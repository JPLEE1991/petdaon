...
/**
 * Servlet implementation class AdminAskBoardServlet
 */
@WebServlet("/admin/askBoard")
public class AdminAskBoardServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request
			.getRequestDispatcher("/WEB-INF/views/admin/manage_serviceCenter/askBoard.jsp")
