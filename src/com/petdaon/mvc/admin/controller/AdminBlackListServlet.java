 ...
 */
@WebServlet("/admin/adminblackList")
public class AdminBlackListServlet extends HttpServlet {
	...
	private void doList(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		List<Member> list = memberService.selectMemberBlackList(keyword, start, end);
		...
		req
			.getRequestDispatcher("/WEB-INF/views/admin/adminblackList.jsp")
			.forward(req, res);
	}
}
