 ...
 */
@WebServlet("/views/gallery_board/boardEnroll")
public class GalleryBoardEnrollServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String saveDirectory = application.getRealPath("/upload/gallery_board");
